...
export default function SideBySideContent({ fields }) {
  return (
    <div className='flex flex-wrap flex-col lg:flex-row w-full mx-auto max-w-screen-lg justify-center my-[30px] mx-[22px] px-[10px]'>
      <div className='flex lg:w-1/2 w-full justify-center pr-5'>
        <MediaVideo fields={fields?.leftContent} />
      </div>
